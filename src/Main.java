...
public class Main {
                ...
                if (scanner.hasNextInt()) {
                    ...
                    switch (menu) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            LocalDate date1 = inputDate(scanner);
                            for (Task t : taskHolder.getTaskOnDay(date1)) {
                                System.out.println(t);
                            }
                            break;
                        case 4:
                            LocalDate date2 = inputDate(scanner);
                            int days = inputNumberOfDay(scanner);
                            for (Map.Entry<LocalDate, List<Task>> pair : taskHolder.getTasks(date2, days).entrySet()) {
    ...
    private static void printMenu() {
        ...
        System.out.println("3. Получить задачи на день");
        System.out.println("4. Получить задачи на несколько дней");
